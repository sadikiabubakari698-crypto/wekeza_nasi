...
export default function Somo19() {
  return (
    <main style={{ padding: "1.75rem", maxWidth: "600px", margin: "0 auto", fontFamily: "var(--font-sans)", lineHeight: 1.6, color: "#1a1a1a", background: "#ffffff", minHeight: "100vh" }}>
      ...
      <h2 style={{ color: "#1a1a1a", marginTop: 0 }}>Somo la 19: Kusoma Mwenendo wa Bei kwa Siku Nyingi</h2>
      <LessonStepper
        steps={steps}
        quiz={quiz}
        lessonTitle="Somo la 19: Kusoma Mwenendo wa Bei kwa Siku Nyingi"
        lessonHref="/somo19"
        nextHref="/somo20"
        nextLabel="Somo la 20"
      />
    </main>
  );
}
